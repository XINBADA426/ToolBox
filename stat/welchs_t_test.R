# Title     : welchs_t_test.R
# Objective : Welch's T test
# Created by: MingJia
...
for (compare in compares) {
  ...
  result["p"] <- apply(result, 1, function(x) t.test(x[group1_samples], x[group2_samples], alternative = "two.sided", var.equal = FALSE)$p.value)
